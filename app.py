...
class Transcript(Resource):
    ...
    def translate_text(self, text, target_language):
        os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = f"capstone-project-sumrizz-6140b1094d8d.json"
    ...
    def post(self):
        ...
        if self.data['type'] == 'link':
            ...
            try:
                ...
                translate_transcription = self.translate_text(self.data['transcription'],self.data['language'] )
                clean_translate_transcription =  re.sub("&#39;","'", translate_transcription)
                self.data[f"{ self.data['language']}_transcription"] = clean_translate_transcription
            ...
            try:
                en_transcription = self.translate_text(self.data['source'])
